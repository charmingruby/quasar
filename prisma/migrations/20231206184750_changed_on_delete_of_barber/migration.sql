...
CREATE TABLE "new_Scheduling" (
    ...
    CONSTRAINT "Scheduling_barberAccountId_fkey" FOREIGN KEY ("barberAccountId") REFERENCES "BarberAccount" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_Scheduling" ("age_category", "barberAccountId", "createdAt", "customerAccountId", "date", "endAt", "free", "id", "name", "observation", "price", "promoCodeId", "status", "time", "timeInAQuarterOfAnHourQuantity", "updatedAt") SELECT "age_category", "barberAccountId", "createdAt", "customerAccountId", "date", "endAt", "free", "id", "name", "observation", "price", "promoCodeId", "status", "time", "timeInAQuarterOfAnHourQuantity", "updatedAt" FROM "Scheduling";
