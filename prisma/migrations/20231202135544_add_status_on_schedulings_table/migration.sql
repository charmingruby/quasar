...
INSERT INTO "new_Scheduling" ("barberAccountId", "createdAt", "customerAccountId", "cutId", "date", "id", "promoCodeId", "time", "updatedAt") SELECT "barberAccountId", "createdAt", "customerAccountId", "cutId", "date", "id", "promoCodeId", "time", "updatedAt" FROM "Scheduling";
