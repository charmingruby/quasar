/*
  ...
  - You are about to drop the column `free` on the `Scheduling` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "PromoCode" ADD COLUMN "usedByCreator" BOOLEAN DEFAULT false;
